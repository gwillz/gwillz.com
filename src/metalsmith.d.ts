// Pulled from: https://github.com/segmentio/metalsmith/pull/296

// Type definitions for metalsmith 2.3
// Project: https://github.com/segmentio/metalsmith
// Definitions by: Brian Lagerman <https://github.com/brianlagerman>
// Definitions: https://github.com/segmentio/metalsmith
...
declare module "metalsmith" {
    ...
    interface Metalsmith {
         ...
         * @param directory {string} - Relative or absolute `working` directory path.
         * @example
         ...
         * @param path {string} [path='src'] - Relative or absolute `source` directory path.
         * @example
         ...
         * @param path {string} [path='build'] - Relative or absolute `destination` directory path.
         * @example
         ...
         * @param max {number} [max=Infinity] - The `maximum` number of open files.
         * @example
         ...
         * @param clean {boolean} [clean=true] - Flag to `clean` destination directory.
         * @example
         ...
         * @param frontmatter {boolean} [frontmatter=true] - Flag to parse YAML `frontmatter`.
         * @example
         ...
         * @param metadata {object} - The global metadata (json).
         * @example
         ...
         * @param plugin {function | array} - The plugin to add.
         * @example
         ...
         * @param files {string | string[] | function | function[]} - The file(s) or directories to `ignore`.
         * @example
         ...
         * @param paths {string[]} - The `paths` to resolve.
         * @example
         ...
         * @param files {object} - The dictionary of files.
         * @param fn - Optional Callback function.
         * @example
         ...
         * @param dir {string} - Optional dictionary of files.
         * @example
         ...
         * @param files {object} - Dictionary of files.
         * @param dir {string} - Optional destination directory.
         * @param fn - Optional Callback function.
         * @example
         ...
         * @param data {object} - The file data.
         * @example
    ...
    namespace Metalsmith {
        type Plugin = (...args: any[]) => void;
        type Callback = (err: Error, files: { [index: string]: any }, metalsmith: Metalsmith) => void;
